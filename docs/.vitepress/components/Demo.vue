...
import { computed, toRef, ref, getCurrentInstance, watch } from "vue";
import { useClipboard, useToggle, computedAsync } from "@vueuse/core";
...
<template>
  <div>
    <p v-if="decodedDescription" text="sm" v-html="decodedDescription"></p>
    <div class="example">
      ...
      <el-divider v-show="sourceVisible"></el-divider>
